...
public class FileController {
    ...
    private class HealthCheck implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
                ...
                return exchange.sendResponseHeaders(200,response.getBytes().length);
        }
    }
...
//                String dataAsString = new String(data);
                ...
                int headerEnd = findSequence(data, "\r\n\r\n".getBytes(), 0);
                if (headerEnd == -1) return null;

                String dataAsString =  new String(data, 0, headerEnd, StandardCharsets.UTF_8)+"\r\n";
